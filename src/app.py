...
class FootballAnalyzer:
    ...
    def set_video_path(self, demo_selected, input_video_file):
        demo_vid_paths = {
            "Demo 1": os.path.join(DATA_DIR, 'demo1.mp4'),
            "Demo 2": os.path.join(DATA_DIR, 'demo2.mp4')
        }
    ...
    def setup_player_detection_tab(self, tab):
        ...
        output_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'pd_output_{timestamp}.mp4')
        ...
        if start_detection:
            ...
            st.video(output_path, format="video/mp4", start_time=0, subtitles=None, end_time=None, loop=False, autoplay=False, muted=False)
    ...
    def setup_player_tracking_tab(self, tab):
        ...
        status = False
        timestamp = time.strftime('%H%M%S')
        output_path =os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'pt_output_{timestamp}.mp4')
    ...
    def setup_field_detection_tab(self, tab):
        ...
        status = False
        timestamp = time.strftime('%H%M%S')
        output_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'fd_output_{timestamp}.mp4')
    ...
    def setup_ball_detection_tab(self, tab):
        ...
        status = False
        timestamp = time.strftime('%H%M%S')
        output_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'bd_output_{timestamp}.mp4')
    ...
    def setup_team_classification_tab(self, tab):
        ...
        status = False
        timestamp = time.strftime('%H%M%S')
        output_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'tc_output_{timestamp}.mp4')
    ...
    def setup_player_localization_tab(self, tab):
        ...
        stframe = col1.empty()
        #st.sidebar.markdown('---')
        stframe_map = col2.empty()

        cap = cv2.VideoCapture(self.tempf.name)
        status = False
        timestamp = time.strftime('%H%M%S')
        output_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'pl_output_{timestamp}.mp4')
        output_map_path = os.path.join(DATA_DIR, f'{output_file_name}_{timestamp}.mp4') if save_output else os.path.join(DATA_DIR, f'pl_output_map_{timestamp}.mp4')
        ...
        if start_detection:
            ...
            main(
                source_video_path=self.tempf.name,
                target_video_path=output_path,
                target_video_map_path=output_map_path,
                device='cuda:0',
